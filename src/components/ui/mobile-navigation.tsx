...
export const MobileNavigation = (props: MobileNavigationProps) => {
  ...
  return (
    <nav
      ...
      className={cn(
        "fixed bottom-3 left-1/2 z-40 flex w-[calc(100%-1.5rem)] max-w-sm -translate-x-1/2 gap-1.5 rounded-full border border-white/10 bg-slate-950/75 px-2 py-2 shadow-[0_18px_40px_rgba(0,0,0,0.26)] backdrop-blur-xl transition duration-300 2xl:hidden",
        className
      )}
      {...rest}
    >
