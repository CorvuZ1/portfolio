          ...
          {sections.map((section, index) => {
            ...
            return (
              <a
                ...
                href={`#${section.id}`}
                className={cn(
                  "rounded-full border px-3.5 py-2 text-xs transition sm:px-4 sm:text-sm border-white/10 bg-white/5 text-slate-300 hover:border-white/30 hover:text-white",
                  isFirst &&
